...
int hopfion(void) {
    ...
    grid_renderer_integrate(&g, ip, 1000, 1000);
    ip.current_func = create_current_stt_dc(10e10 * 0.12, 0, 0.1);
    //ip.current_func = create_current_she_dc(10e10 * 0.12, v3d_c(1, 0, 0), 0.1);
