...
cmd_parser = utils.CMDArgs("./output/start.bin", "./imgs/end_lattice.png")
...
ax.text(x0 + 0.5, y0 + 5.5, "m$\\mathsf{_y}$", verticalalignment='center', horizontalalignment='center')

ax.text(x0 + 5.5, y0 + 0.5, "m$\\mathsf{_x}$", verticalalignment='center', horizontalalignment='center')
