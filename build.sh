#!/bin/sh
set -xe
CFLAGS="-DnPROFILING -Wall -Wextra -pedantic -O3 -ggdb -I ./include -DCL_TARGET_OPENCL_VERSION=300 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -Wno-overlength-strings -Wno-override-init -fsanitize=undefined "
