...
clGetPlatformInfo(cl_platform_id   platform,
                  cl_platform_info paramss_name,
                  size_t           paramss_value_size,
                  void *           paramss_value,
                  size_t *         paramss_value_size_ret) CL_API_SUFFIX__VERSION_1_0;
...
clGetCommandQueueInfo(cl_command_queue      command_queue,
                      cl_command_queue_info paramss_name,
                      size_t                paramss_value_size,
                      void *                paramss_value,
                      size_t *              paramss_value_size_ret) CL_API_SUFFIX__VERSION_1_0;
...
clGetPipeInfo(cl_mem           pipe,
              cl_pipe_info     paramss_name,
              size_t           paramss_value_size,
              void *           paramss_value,
              size_t *         paramss_value_size_ret) CL_API_SUFFIX__VERSION_2_0;
...
clGetProgramBuildInfo(cl_program            program,
                      cl_device_id          device,
                      cl_program_build_info paramss_name,
                      size_t                paramss_value_size,
                      void *                paramss_value,
                      size_t *              paramss_value_size_ret) CL_API_SUFFIX__VERSION_1_0;
...
clSetKernelExecInfo(cl_kernel            kernel,
                    cl_kernel_exec_info  paramss_name,
                    size_t               paramss_value_size,
                    const void *         paramss_value) CL_API_SUFFIX__VERSION_2_0;

#endif

extern CL_API_ENTRY cl_int CL_API_CALL
clGetKernelInfo(cl_kernel       kernel,
                cl_kernel_info  paramss_name,
                size_t          paramss_value_size,
                void *          paramss_value,
                size_t *        paramss_value_size_ret) CL_API_SUFFIX__VERSION_1_0;
...
clGetKernelArgInfo(cl_kernel       kernel,
                   cl_uint         arg_indx,
                   cl_kernel_arg_info  paramss_name,
                   size_t          paramss_value_size,
                   void *          paramss_value,
                   size_t *        paramss_value_size_ret) CL_API_SUFFIX__VERSION_1_2;
...
clGetKernelWorkGroupInfo(cl_kernel                  kernel,
                         cl_device_id               device,
                         cl_kernel_work_group_info  paramss_name,
                         size_t                     paramss_value_size,
                         void *                     paramss_value,
                         size_t *                   paramss_value_size_ret) CL_API_SUFFIX__VERSION_1_0;
...
clGetKernelSubGroupInfo(cl_kernel                   kernel,
                        cl_device_id                device,
                        cl_kernel_sub_group_info    paramss_name,
                        size_t                      input_value_size,
                        const void*                 input_value,
                        size_t                      paramss_value_size,
                        void*                       paramss_value,
                        size_t*                     paramss_value_size_ret) CL_API_SUFFIX__VERSION_2_1;
...
clGetEventProfilingInfo(cl_event            event,
                        cl_profiling_info   paramss_name,
                        size_t              paramss_value_size,
                        void *              paramss_value,
                        size_t *            paramss_value_size_ret) CL_API_SUFFIX__VERSION_1_0;
