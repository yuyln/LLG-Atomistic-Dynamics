...
clGetCommandBufferInfoKHR_t(
    cl_command_buffer_khr command_buffer,
    cl_command_buffer_info_khr paramss_name,
    size_t paramss_value_size,
    void* paramss_value,
    size_t* paramss_value_size_ret);
...
typedef struct _cl_mutable_dispatch_exec_info_khr {
    cl_uint paramss_name;
    size_t paramss_value_size;
    const void* paramss_value;
...
clGetMutableCommandInfoKHR_t(
    cl_mutable_command_khr command,
    cl_mutable_command_info_khr paramss_name,
    size_t paramss_value_size,
    void* paramss_value,
    size_t* paramss_value_size_ret);
...
clGetDeviceImageInfoQCOM_t(
    ...
    cl_image_pitch_info_qcom paramss_name,
    size_t paramss_value_size,
    void* paramss_value,
    size_t* paramss_value_size_ret);
...
clGetKernelSubGroupInfoKHR(
    ...
    size_t paramss_value_size,
    void* paramss_value,
    size_t* paramss_value_size_ret) CL_API_SUFFIX__VERSION_2_0_DEPRECATED;
...
clGetSemaphoreInfoKHR_t(
    cl_semaphore_khr sema_object,
    cl_semaphore_info_khr paramss_name,
    size_t paramss_value_size,
    void* paramss_value,
    size_t* paramss_value_size_ret);
...
clSetKernelExecInfoARM_t(
    cl_kernel kernel,
    cl_kernel_exec_info_arm paramss_name,
    size_t paramss_value_size,
    const void* paramss_value);
...
clSetKernelExecInfoARM(
    ...
    cl_kernel_exec_info_arm paramss_name,
    size_t paramss_value_size,
    const void* paramss_value) CL_API_SUFFIX__VERSION_1_2;
...
clGetAcceleratorInfoINTEL_t(
    ...
    cl_accelerator_info_intel paramss_name,
    size_t paramss_value_size,
    void* paramss_value,
    size_t* paramss_value_size_ret);
...
clGetMemAllocInfoINTEL_t(
    cl_context context,
    const void* ptr,
    cl_mem_info_intel paramss_name,
    size_t paramss_value_size,
    void* paramss_value,
    size_t* paramss_value_size_ret);
...
/* clGetEventInfo response when paramss_name is CL_EVENT_COMMAND_TYPE */
#define CL_COMMAND_READ_HOST_PIPE_INTEL                     0x4214
#define CL_COMMAND_WRITE_HOST_PIPE_INTEL                    0x4215

/* clGetProgramInfo paramss_name */
...
clGetImageRequirementsInfoEXT_t(
    ...
    cl_image_requirements_info_ext paramss_name,
    size_t paramss_value_size,
    void* paramss_value,
    size_t* paramss_value_size_ret);
...
clGetImageRequirementsInfoEXT(
    ...
    size_t paramss_value_size,
    void* paramss_value,
    size_t* paramss_value_size_ret) CL_API_SUFFIX__VERSION_3_0;
